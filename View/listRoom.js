...
const ListRoom = ({ navigation }) => {
    ...
    useEffect(() => {
        if (isLoaded) {
            axios
                .get(`http://192.168.50.104:3000/api/rooms/?quan=${quanc}`, {
                    params: {
                        _page: currentPage,
                        _limit: itemsPerPage,
                    ...
                    >
                        <View style={{ flexDirection: "row", height: 130, marginBottom: 20 }}>
                            ...
                            <View>
                                ...
                                <Text style={{ marginHorizontal: 10, fontSize: 15, fontWeight: "bold", color: "orange" }}> {item.price}.000.000 /tháng </Text>
